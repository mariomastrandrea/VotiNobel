...
public class VotiNobelModel implements Model
{
	...
	public VotiNobelModel()
	{
		this.esameDao = new EsameDAO();
		this.insiemeEsamiDiPartenza = this.esameDao.getTuttiGliEsami();
	}
	
	public Set<Set<Esame>> migliorSottoinsiemeEsamiDa(int numeroCrediti) 
	{
		...
		var result = new HashSet<Set<Esame>>();
		result.add(this.soluzioneMigliore);
	...
	public double calcolaMedia(Set<Esame> esami) 
	{
		...
		return (double)somma/(double)crediti;
	}
